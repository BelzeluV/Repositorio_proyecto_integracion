...
class UserForm(UserCreationForm):
    ...
    first_name          = forms.CharField(widget=forms.TextInput(attrs={"class": "form-control form-control-sm", "placeholder": "ej: Pedro","maxlength": "11",'required': 'required'}))
    last_name           = forms.CharField(widget=forms.TextInput(attrs={"class": "form-control form-control-sm", "placeholder": "ej: Riquelme Sandoval","maxlength": "11",'required': 'required'}))
    ...
    nombre_real         = forms.CharField(widget=forms.TextInput(attrs={"class": "form-control form-control-sm", "placeholder": "ej: Juan Perez",'required': 'required'}))
    ...
    class Meta:
        ...
        fields          = 'first_name','last_name','username','password1','password2','nombre_real','RUT','nacimiento','email','genero','telefono','Direccion','comuna',#'foto_de_Usuario', 